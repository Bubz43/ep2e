...
export const registerEPSettings = once(() => {
  ...
  const alwaysResizableWindows = registerSystemSetting<boolean>(
    'alwaysResizableWindows',
    {
      name: 'Always Resizable EP Windows',
      scope: 'client',
      hint: 'Force all windows generated by the EP system to be resizable in both directions. Changing setting will reload foundry.',
      config: true,
      default: false,
      type: Boolean,
