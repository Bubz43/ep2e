...
declare module "common/utils/helpers" {
     ...
     */
    export function diffObject(original: object, other: object, { inner }?: {
        inner: boolean;
    }): object;
    /**
     ...
     */
    export function filterObject(source: object, template: object, { keepSpecial, templateValues }?: {
        keepSpecial: boolean;
     ...
     */
    export function mergeObject(original: object, other?: object, { insertKeys, insertValues, overwrite, recursive, inplace, enforceTypes }?: {
        insertKeys: boolean;
...
declare module "common/abstract/document" {
     ...
     * @memberof abstract
     */
    class Document {        readonly parent: Document | null; readonly pack?: string | null; readonly data: { _id: string }
        /**
         ...
         */
        static createDocuments(data?: object[], context?: {
            /**
         ...
         */
        static updateDocuments(updates?: object[], context?: {
            /**
             * A parent Document within which these Documents should be embedded
             */
            parent?: Document;
         ...
         */
        static deleteDocuments(ids?: string[], context?: {
            /**
             * A parent Document within which these Documents should be embedded
             */
            parent?: Document;
         ...
         */
        static create(data?: object, context?: {
            /**
             * A parent Document within which these Documents should be embedded
             */
            parent?: Document;
         ...
         * @protected
         */
        protected static _onCreateDocuments(documents: Document[], context: {
            /**
             * A parent Document within which these Documents should be embedded
             */
            parent?: Document;
         ...
         * @protected
         */
        protected static _onUpdateDocuments(documents: Document[], context: {
            /**
             * A parent Document within which these Documents should be embedded
             */
            parent?: Document;
         ...
         * @protected
         */
        protected static _onDeleteDocuments(documents: Document[], context: {
            /**
             * A parent Document within which these Documents should be embedded
             */
            parent?: Document;
         ...
         */
        constructor(data?: object, context?: {
            parent: Document;
            pack: string;
        });
        /**
         ...
         */
        testUserPermission(user: any, permission: string | number, { exact }?: {
            exact: boolean;
        }): boolean;
        /**
         ...
         * @return {Promise<Document[]>}              An array of created Document instances
         */
        createEmbeddedDocuments(embeddedName: string, data?: object[], context?: {
            /**
             * A parent Document within which these Documents should be embedded
             */
            parent?: Document;
         ...
         * @return {Promise<Document[]>}              An array of updated Document instances
         */
        updateEmbeddedDocuments(embeddedName: string, updates?: object[], context?: {
            /**
             * A parent Document within which these Documents should be embedded
             */
            parent?: Document;
         ...
         * @return {Promise<Document[]>}              An array of deleted Document instances
         */
        deleteEmbeddedDocuments(embeddedName: string, ids: string[], context?: {
            /**
             * A parent Document within which these Documents should be embedded
             */
            parent?: Document;
         ...
         * @protected
         */
        protected _preCreate(data: object, options: object, user: any): Promise<void>;
        /**
         ...
         * @protected
         */
        protected _preUpdate(changed: object, options: object, user: any): Promise<void>;
        /**
...
declare module "common/abstract/backend" {
    ...
    class DatabaseBackend {
         ...
         * @protected
         */
        protected _getDocuments(documentClass: any, query: any, options: any, user: any): Promise<void>;
        /**
         * Get embedded Document instances
         * @protected
         */
        protected _getEmbeddedDocuments(documentClass: any, parent: any, query: any, options: any, user: any): Promise<void>;
        /**
         ...
         * @protected
         */
        protected _createDocuments(documentClass: any, request: any, user: any): Promise<Document[]>;
        /**
         * Create embedded Document instances
         * @returns {Promise<Document[]>}
         * @protected
         */
        protected _createEmbeddedDocuments(documentClass: any, parent: any, request: any, user: any): Promise<Document[]>;
        /**
         ...
         * @protected
         */
        protected _updateDocuments(documentClass: any, request: any, user: any): Promise<Document[]>;
        /**
         * Update embedded Document instances
         * @returns {Promise<Document[]>}
         * @protected
         */
        protected _updateEmbeddedDocuments(documentClass: any, parent: any, request: any, user: any): Promise<Document[]>;
        /**
         ...
         * @protected
         */
        protected _deleteDocuments(documentClass: any, request: any, user: any): Promise<Document[]>;
        /**
         * Delete embedded Document instances
         * @returns {Promise<Document[]>}
         * @protected
         */
        protected _deleteEmbeddedDocuments(documentClass: any, parent: any, request: any, user: any): Promise<Document[]>;
        /**
         ...
         * @protected
         */
        protected _logOperation(action: string, type: string, documents: any[], { parent, pack, level }?: { parent: unknown, pack: string, level: string}): void;
        /**
...
declare module "common/abstract/data" {
    ...
    class DocumentData {
         ...
         * @protected
         */
        protected static _getFieldDefaultValue(field: DocumentField, data: object): undefined | any;
        /**
         ...
         */
        validate({ changes, children, clean, replace, strict, }?: {
            changes: object;
            children: boolean;
            clean: boolean;
            replace: boolean;
         ...
         * @protected
         */
        protected _getMissingFieldErrorMessage(name: string, field: DocumentField): string;
        /**
         ...
         * @protected
         */
        protected _getInvalidFieldValueErrorMessage(name: string, field: DocumentField, value: any): string;
        /**
         ...
         * @protected
         */
        protected _validateField(name: string, field: DocumentField, value: any, { children }?: { children?: boolean}): any;
        /**
         ...
         */
        updateCollection(collection: EmbeddedCollection, documentData: DocumentData[], options?: object): void;
        /**
...
declare module "common/data/validators" {
     ...
     * @private
     */
    export function _hasFileExtension(path: string, extensions: string[]): boolean;
    /**
...
declare module "common/data/fields" {
     ...
     * @returns {DocumentField}
     */
    export function embeddedCollectionField(document: Function, options?: object): any;
    /**
...
declare module "common/documents" {
    ...
    export class BaseActor extends Document {
         ...
         */
        migrateSystemData({ insertKeys, insertValues, enforceTypes, }?: {
            insertKeys: boolean;
            insertValues: boolean;
            enforceTypes: boolean;
        }): object;
